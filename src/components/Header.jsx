      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <NavLink to="/propertydetails" className={getNavLinkClass}>Rent</NavLink>
            <NavLink to="#" className={getNavLinkClass}>Sell</NavLink>
            ...
            <NavLink to="#" className={getNavLinkClass}>Help</NavLink>
          </div>
